/*ім'я пакета1, модифікатори та ім'я аналізованого класу1, його базовий клас1, список
        реалізованих інтерфейсів1, список усіх полів1, конструкторів та методів1, та їх характеристики.*/
...
public abstract class ClassInfo {
    public static void getInfo(Class<?> myClass){
        ...
        infoClass.append("Name: " + myClass + "\n");
        infoClass.append("Modifiers: " + myClass.getModifiers() + "\n");
